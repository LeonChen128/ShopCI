...
<div class="myHomeTable">
  ...
  <form action="<?= base_url('myHome/resetPhoto')?>" method="post" enctype="multipart/form-data">
  ...
  <form action="<?= base_url('myHome/resetName')?>" method="post" class="myHomeFormTable2">
